/**
* @author: craig[]craftedsoftware-co-za
* @version: 1
* edited: July 2014
* plugin name: StandardSlider
*/
(function($) {
	$.fn.StandardSlider = function(userConfig) {
		// default properties for user-editable values
		$.fn.StandardSlider.config = {
			slideTime: 5000,
			animTime: 1000,
			autoAnim: false,
			animInfinity: false,
		...
		function methods(){
			...
			this.setNavActive = function(id){
                ...
                $("li i",$m.props.navContainer).removeClass("active_arrow");
				$("> li:eq(" + id + ")", $m.props.navContainer).addClass("active");
                $("> li:eq(" + id + ") i", $m.props.navContainer).addClass("active_arrow");
			};
			...
			this.buildBackNextLinks = function(){
				...
				backNextNav += '<li class="back-button"><a href="javascript:;"><div id="backButton"></div></a></li>';
				backNextNav += '<li class="next-button"><a href="javascript:;"><div id="nextButton"></div></a></li>';
				backNextNav += '</ul>';
			...
			this.init = function(root){
				...
				$m.props.sRef = $($(".StandardSlider")).index($m.props.sContainer);
		...
		return this.each(function(id, root) {
			...
			var $m = new methods();
			$m.props = $.extend({}, $.fn.StandardSlider.config, userConfig);
			$m.init($(this));
